...
<link rel="apple-touch-icon" href="{{  asset('assets/keditor/probiz/assets/Awards.png') }}">
<meta name="apple-mobile-web-app-title" content="Smartend">
<meta name="csrf-token" content="{{ csrf_token() }}">

<meta name="mobile-web-app-capable" content="yes">
<link rel="shortcut icon" sizes="196x196" href="{{  asset('assets/keditor/probiz/assets/Awards.png')}}">
@stack('before-styles')
